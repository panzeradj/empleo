...
/////////////////////////////////////////////////////////////////////////////////////////////
	...
	function conexion(){
		$conexion = new mysqli("127.0.0.1", "root", "toor", "datosabiertos");
...
$fichero="http://www.datosabiertos.jcyl.es/web/jcyl/risp/es/empleo/ofertas-empleo/1284354353012.csv";
        ...
        $titulos=fgets($fh);
        $contador=0;
        $tofind = utf8_decode("¡¿¬√ƒ≈‡·‚„‰Â“”‘’÷ÚÛÙıˆ¯»… ÀËÈÍÎ«ÁÃÕŒœÏÌÓÔŸ⁄€‹˘˙˚¸ˇ—Ò");
...
/////////////////////////////////////////////////////////////////////////////////////////////
	...
	function like($cadena,$busqueda){
		...
		$tofind = utf8_decode("√Ä√Å√Ç√É√Ñ√Ö√†√°√¢√£√§√•√í√ì√î√ï√ñ√≤√≥√¥√µ√∂√∏√à√â√ä√ã√®√©√™√´√á√ß√å√ç√é√è√¨√≠√Æ√Ø√ô√ö√õ√ú√π√∫√ª√º√ø√ë√±");
		$replac = "AAAAAAaaaaaaOOOOOooooooEEEEeeeeCcIIIIiiiiUUUUuuuuyNn";
...
/////////////////////////////////////////////////////////////////////////////////////////////
	...
	function generarEmail(){
		...
		if($resultado = $conexion->query($sql)){
			while($row = $resultado->fetch_array()){				
				$cadena="Puedes visitar el siguiente enlace para ver las ofertas de empleo personalizadas: <a href='http://v-espino.com/~chema/daw2/proyectos/2014/empleojcyl/oferts?e=".$row[4]."'>OFERTAS EMPLEOJCYL</a><br><br><br><br><br><br>Puede darse de baja desde <a href=http://v-espino.com/~chema/daw2/proyectos/2014/empleojcyl/fiqnpv/unsubscribe?=".$row[4].">aqui</a>";
	...
	function enviarEmail($email,$cadena){    
		...
		$mail->Password = "DataTravel*"; // Contrase√±a
		...
		if(!$exito){
			//echo "Problemas enviando correo electr√≥nico a ";
