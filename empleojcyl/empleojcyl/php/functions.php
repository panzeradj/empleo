	...
	function generarEmail(){
		...
		if($resultado = $conexion->query($sql)){
			while($row = $resultado->fetch_array()){				
				$cadena="<a href='http://v-espino.com/~chema/daw2/proyectos/2014/empleojcyl/oferts?e=".$row[4]."'>OFERTAS DE EMEPLO JCYL</a><br><br><br><br><br><br>Puede darse de baja <a href=http://v-espino.com/~chema/daw2/proyectos/2014/empleojcyl/fiqnpv/unsubscribe?=".$row[4].">aqui</a>";
