		...
		<main>
			...
			<section>
				<article id="principal">
					<h1>ALgunas Ofertas de Empleo disponibles <span>Encuentra empleo en CyL de forma rapida y efectiva</span></h1>
				...
				<article id="welcome">
					<div id="welcome_susbscribe">
						...
						<h1>FUTURO</h1>
						<a href="./subscribe.php" class="boton letraGrande rosa"> Recibir alertas </a>
					</div>					
				</article>
			</section>		
